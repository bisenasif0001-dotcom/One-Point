...
const services = [
  ...
  { slug: "pan-status-check", name: "PAN Application Status Check", category: "E-Services", price: 199, taxRate: 0 },
  { slug: "pan-aadhaar-link", name: "PAN–Aadhaar Linking & Status Support", category: "E-Services", price: 199, taxRate: 0 },
  { slug: "duplicate-pan-surrender", name: "Duplicate PAN Surrender Guidance", category: "E-Services", price: 199, taxRate: 0 },
  { slug: "ayushman-card", name: "Ayushman Card", category: "E-Services", price: 199, taxRate: 0 },
  { slug: "voter-id", name: "Voter ID", category: "E-Services", price: 149, taxRate: 0 },
  { slug: "voter-id-new-enrollment", name: "Voter ID New Enrollment Assistance", category: "E-Services", price: 149, taxRate: 0 },
  { slug: "overseas-voter-registration", name: "Overseas / NRI Voter Registration Assistance", category: "E-Services", price: 199, taxRate: 0 },
  { slug: "voter-id-correction", name: "Voter ID Correction & Update Support", category: "E-Services", price: 149, taxRate: 0 },
  { slug: "voter-id-transfer", name: "Voter ID Address / Constituency Transfer Assistance", category: "E-Services", price: 149, taxRate: 0 },
  { slug: "replacement-voter-id", name: "Replacement Voter ID Application Support", category: "E-Services", price: 149, taxRate: 0 },
  { slug: "voter-id-photo-update", name: "Voter ID Photo Update Assistance", category: "E-Services", price: 149, taxRate: 0 },
  { slug: "pwd-electoral-marking", name: "PwD Marking in Electoral Roll Assistance", category: "E-Services", price: 99, taxRate: 0 },
  { slug: "voter-name-deletion", name: "Name Deletion from Electoral Roll Assistance", category: "E-Services", price: 149, taxRate: 0 },
  { slug: "voter-enrollment-objection", name: "Objection to Incorrect Voter Enrollment Assistance", category: "E-Services", price: 149, taxRate: 0 },
  { slug: "e-epic-download-assistance", name: "e-EPIC Voter Card Download Assistance", category: "E-Services", price: 49, taxRate: 0 },
  { slug: "voter-name-search", name: "Name Search in Electoral Roll", category: "E-Services", price: 0, taxRate: 0 },
  { slug: "electoral-roll-pdf", name: "Electoral Roll PDF Download Assistance", category: "E-Services", price: 29, taxRate: 0 },
  { slug: "voter-status-tracking", name: "Voter Application Status Tracking Assistance", category: "E-Services", price: 0, taxRate: 0 },
  { slug: "voter-complaint-registration", name: "Voter Complaint Registration Assistance", category: "E-Services", price: 49, taxRate: 0 },
  { slug: "passport-assistance", name: "Passport Assistance", category: "E-Services", price: 299, taxRate: 0 },
  { slug: "fresh-passport-assistance", name: "Fresh Passport Application Assistance", category: "E-Services", price: 299, taxRate: 0 },
  { slug: "passport-renewal-reissue", name: "Passport Renewal & Re-Issue Support", category: "E-Services", price: 299, taxRate: 0 },
  { slug: "tatkaal-passport-help", name: "Tatkaal Passport Processing Help", category: "E-Services", price: 499, taxRate: 0 },
  { slug: "minor-passport-support", name: "Minor Passport Application Support", category: "E-Services", price: 299, taxRate: 0 },
  { slug: "pcc-guidance", name: "Police Clearance Certificate (PCC) Guidance", category: "E-Services", price: 199, taxRate: 0 },
  { slug: "aadhaar-services-assistance", name: "Aadhaar Services Assistance", category: "E-Services", price: 199, taxRate: 0 },
  ...
  { slug: "police-verification", name: "Pension & Welfare Schemes", category: "E-Services", price: 199, taxRate: 0 },
  { slug: "citizen-security-cybercrime-police-help", name: "Citizen Security, Cybercrime & Police Help", category: "E-Services", price: 199, taxRate: 0 },
  { slug: "pension-welfare-schemes-assistance", name: "Pension & Welfare Schemes", category: "E-Services", price: 199, taxRate: 0 },
  { slug: "pension-welfare-schemes-assistance", name: "Pension & Welfare Schemes", category: "E-Services", price: 199, taxRate: 0 },
  { slug: "pension-welfare-schemes", name: "Pension & Welfare Schemes", category: "E-Services", price: 199, taxRate: 0 },
  ...
  { slug: "income-tax-assistance", name: "Income Tax Assistance", category: "ProServe", price: 199, taxRate: 0 },
  { slug: "itr-filing-consultancy", name: "Income Tax Return ( ITR ) Filing Consultancy", category: "ProServe", price: 299, taxRate: 0 },
  { slug: "income-tax-portal-registration", name: "Income Tax Portal Registration Assistance", category: "ProServe", price: 99, taxRate: 0 },
  { slug: "form-26as-download", name: "Form 26AS Download Assistance", category: "ProServe", price: 49, taxRate: 0 },
  { slug: "ais-tis-download", name: "AIS / TIS Download Assistance", category: "ProServe", price: 49, taxRate: 0 },
  { slug: "income-tax-refund-status", name: "Income Tax Refund Status Check", category: "ProServe", price: 49, taxRate: 0 },
